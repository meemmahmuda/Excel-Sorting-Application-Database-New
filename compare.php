...
<div style="width:450px; margin:50px auto; padding:25px; border:1px solid #ccc; border-radius:8px; background:#f9f9f9; box-shadow:0 2px 8px rgba(0,0,0,0.1); font-family:Arial, sans-serif; text-align:center;">
    ...
    <p style="font-size:16px; color:<?php echo $hasUnmatched ? '#d9534f' : '#28a745'; ?>; font-weight:bold; margin-bottom:25px;">
        <?php echo htmlspecialchars($message); ?>
    </p>

    <?php if($hasUnmatched): ?>
        <a href="download.php" style="display:inline-block; padding:12px 25px; background:#4CAF50; color:white; text-decoration:none; border-radius:5px; font-weight:bold; transition:background 0.3s;">
            Go to Download Page
        </a>
    <?php endif; ?>
</div>
